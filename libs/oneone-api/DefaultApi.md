...
[**getApiV1TapirHorseSeriesCardGet**](DefaultApi.md#getApiV1TapirHorseSeriesCardGet) | **GET** /api/v1/tapir/horse/series/card/get | 
...
# **postApiV1TapirHorseCardCommentCreate**
> OptionDataKunCommentWithDate postApiV1TapirHorseCardCommentCreate(reqCreateCardComment1, )
...
let body:.DefaultApiPostApiV1TapirHorseCardCommentCreateRequest = {
...
apiInstance.postApiV1TapirHorseCardCommentCreate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirHorseLoginByPassword**
> OptionDataString postApiV1TapirHorseLoginByPassword(loginTribeUser)
...
let body:.DefaultApiPostApiV1TapirHorseLoginByPasswordRequest = {
  // LoginTribeUser
  loginTribeUser: {
    userName: "userName_example",
...
apiInstance.postApiV1TapirHorseLoginByPassword(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirHorseSeriesCardCreate**
> OptionDataHashLong postApiV1TapirHorseSeriesCardCreate(reqCreateHorseCard, )
...
let body:.DefaultApiPostApiV1TapirHorseSeriesCardCreateRequest = {
  // ReqCreateHorseCard
  reqCreateHorseCard: {
    seriesId: "seriesId_example",
    title: "title_example",
    ...
    videoName: "videoName_example",
    file: "file_example",
    audioName: "audioName_example",
    tags: [
      "tags_example",
    ],
    postType: "TEXT",
...
apiInstance.postApiV1TapirHorseSeriesCardCreate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirHorseSeriesCardUpdate**
> RetMsg postApiV1TapirHorseSeriesCardUpdate(reqUpdateHorseCard, )
...
let body:.DefaultApiPostApiV1TapirHorseSeriesCardUpdateRequest = {
  // ReqUpdateHorseCard
  reqUpdateHorseCard: {
...
apiInstance.postApiV1TapirHorseSeriesCardUpdate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirHorseSeriesDetailCreate**
> RetMsg postApiV1TapirHorseSeriesDetailCreate(reqCreateSeries, )
...
let body:.DefaultApiPostApiV1TapirHorseSeriesDetailCreateRequest = {
  // ReqCreateSeries
  reqCreateSeries: {
    categoryId: 1,
    secondCategoryId: 1,
...
apiInstance.postApiV1TapirHorseSeriesDetailCreate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirHorseSeriesPracticeCreate**
> RetMsg postApiV1TapirHorseSeriesPracticeCreate(reqCreatePractice, )
...
let body:.DefaultApiPostApiV1TapirHorseSeriesPracticeCreateRequest = {
  // ReqCreatePractice
  reqCreatePractice: {
    postId: "postId_example",
    exerciseType: "ENUM_EXERCISE_LINK",
    exerciseId: "exerciseId_example",
    title: "title_example",
    answers: [
      "answers_example",
    ...
    seriesName: "seriesName_example",
    seriesType: "memory",
    postTitle: "postTitle_example",
  },
  // string
  authorization: "Authorization_example",
};

apiInstance.postApiV1TapirHorseSeriesPracticeCreate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirMiniAppLogin**
> OptionDataMiniAppLoginToken postApiV1TapirMiniAppLogin()
...
let body:.DefaultApiPostApiV1TapirMiniAppLoginRequest = {
  // string
  code: "code_example",
};

apiInstance.postApiV1TapirMiniAppLogin(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1TapirMiniAppUserinfoGet**
> OptionDataRetMiniAppUserItem postApiV1TapirMiniAppUserinfoGet(getUserInfo)
...
let body:.DefaultApiPostApiV1TapirMiniAppUserinfoGetRequest = {
  // GetUserInfo
  getUserInfo: {
    appid: "appid_example",
    sessionKey: "sessionKey_example",
    signature: "signature_example",
    rowData: "rowData_example",
    encryptedData: "encryptedData_example",
    iv: "iv_example",
  },
};

apiInstance.postApiV1TapirMiniAppUserinfoGet(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1Test**
> RetMsg postApiV1Test(reqCreateShandianOrder)
...
let body:.DefaultApiPostApiV1TestRequest = {
  // ReqCreateShandianOrder
  reqCreateShandianOrder: {
    paidOrderId: "paidOrderId_example",
    location: {
...
apiInstance.postApiV1Test(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **postApiV1VipShopOrderStart**
> OptionDataVipShopWechatPaymentItem postApiV1VipShopOrderStart(reqStartVipOrder, )
...
let body:.DefaultApiPostApiV1VipShopOrderStartRequest = {
  // ReqStartVipOrder
  reqStartVipOrder: {
    buyNum: 1,
    goodsid: "goodsid_example",
    title: "title_example",
    paidMoney: 3.14,
    description: "description_example",
    attachments: [
...
apiInstance.postApiV1VipShopOrderStart(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
